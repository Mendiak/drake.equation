...
const translations = {
    en: {
        ...
        preset_optimistic_tooltip: "High-end estimate assuming life is common and can thrive.",
        ...
        preset_rare_earth_tooltip: "Hypothesis suggesting complex life is a cosmic rarity.",
        preset_pessimistic: "Pessimistic Scientist",
        preset_pessimistic_tooltip: "Low-end estimate assuming civilizations quickly self-destruct.",
        ...
        desc_drake: "The original probabilistic formula for estimating the number of communicative civilizations in the galaxy.",
        link_fermi: "Fermi Paradox",
        desc_fermi: "The apparent contradiction between the likelihood of extraterrestrial life and the lack of evidence for it.",
        link_astrobiology: "Astrobiology",
        desc_astrobiology: "The scientific study of the origins, evolution, distribution, and future of life in the universe.",
        link_seti: "SETI Institute",
        desc_seti: "The Search for Extraterrestrial Intelligence, an organization dedicated to finding signs of intelligent life beyond Earth.",
        link_exoplanets: "Exoplanets",
        desc_exoplanets: "Planets orbiting stars other than our Sun, key to understanding habitable worlds.",
        ...
        section_galaxy: "Galactic Simulation",
        galaxy_intro: "This visualization represents a simplified model of the Milky Way, where each point of light is a star system. As you adjust the sliders, the stars change color to show how many might pass each filter in the Drake Equation.",
        galaxy_controls_title: "Visualization Controls",
        galaxy_rotation: "Rotation Speed",
        galaxy_tilt: "View Tilt",
        galaxy_zoom: "Zoom Level",
        ...
        desc_oxford: "A comprehensive analysis exploring why we haven't found evidence of extraterrestrial civilizations despite high probabilities.",
        link_hanson: "The Great Filter (Robin Hanson)",
        desc_hanson: "The hypothesis that a significant barrier prevents life from becoming interstellar, explaining the Fermi Paradox.",
    ...
    es: {
        ...
        preset_optimistic_tooltip: "Estimación alta asumiendo que la vida es común y próspera.",
        ...
        preset_rare_earth_tooltip: "Hipótesis que sugiere que la vida compleja es una rareza cósmica.",
        preset_pessimistic: "Científico pesimista",
        preset_pessimistic_tooltip: "Estimación baja asumiendo que las civilizaciones se autodestruyen rápido.",
        ...
        desc_drake: "La fórmula probabilística original para estimar el número de civilizaciones comunicativas en la galaxia.",
        link_fermi: "Paradoja de Fermi",
        desc_fermi: "La aparente contradicción entre la probabilidad de vida extraterrestre y la falta de evidencia de ella.",
        link_astrobiology: "Astrobiología",
        desc_astrobiology: "El estudio científico de los orígenes, evolución, distribución y futuro de la vida en el universo.",
        link_seti: "Instituto SETI",
        desc_seti: "La Búsqueda de Inteligencia Extraterrestre, una organización dedicada a encontrar señales de vida inteligente más allá de la Tierra.",
        link_exoplanets: "Exoplanetas",
        desc_exoplanets: "Planetas que orbitan estrellas distintas al Sol, clave para entender mundos habitables.",
        link_source: "Código fuente",
        section_sensitivity: "Análisis de sensibilidad",
        section_funnel: "Embudo de filtrado cósmico",
        section_galaxy: "Simulación galáctica",
        galaxy_intro: "Esta visualización representa un modelo simplificado de la Vía Láctea, donde cada punto de luz es un sistema estelar. A medida que ajustas los deslizadores, las estrellas cambian de color para mostrar cuántas podrían pasar cada filtro de la Ecuación de Drake.",
        galaxy_controls_title: "Controles de visualización",
        galaxy_rotation: "Velocidad de rotación",
        galaxy_tilt: "Inclinación de vista",
        galaxy_zoom: "Nivel de zoom",
        ...
        galaxy_fullscreen_mobile_only: "La vista en pantalla completa de la simulación solo está disponible en pantallas grandes.",
